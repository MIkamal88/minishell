...
// static char	*expand_variable(t_token *token, int *pos)
// {
// 	char	*expansion;
// 	char	*key;
// 	int		i;
...
// }
//
// static void	variable_quote_expansion(t_token *token, int start, int *size)
// {
// 	char	*prev;
// 	char	*expansion;
// 	char	*next;
...
// 	expansion = expand_variable(token, &pos);
...
// 			variable_quote_expansion(*token, *pos, &size);
// 		size++;
// 	}
